...
export const PrevButton: React.FC<PrevNextButtonPropType> = (props) => {
  ...
  return (
    <button
      className="embla__button absolute left-4 top-1/2 z-20 -translate-y-1/2 transition delay-75 duration-300 ease-out hover:-translate-x-2"
      onClick={onClick}
    >
...
export const NextButton: React.FC<PrevNextButtonPropType> = (props) => {
  ...
  return (
    <button
      className="embla__button  absolute right-4 top-1/2 z-20 -translate-y-1/2  transition delay-75 duration-300 ease-out hover:translate-x-2"
      onClick={onClick}
    >
